...
Here you will find the various certificate programs I have done in the past. These include the following:
...
- Certified SOLIDWORKS Expert - Simulation (CSWE-S)
- Certified SOLIDWORKS Expert - Flow Simulation (CSWE-Flow)
...
- Intro to Statistical Methods with MATLAB
- MATLAB for Data Processing and Visualization
- MATLAB Fundamentals
- MATLAB Image Processing Onramp

# GD&T
- Course completion of Fundamentals of GD&T ASME Y14.5 v2009 by Applied Geometrics, Inc.

# Cornell University
- Fluid Dynamics Simulations Using Ansys certificate program completion

# Engineer-in-Training
- EIT License # EIT 175039

And others available on my LinkedIn I felt were not worth including here.
